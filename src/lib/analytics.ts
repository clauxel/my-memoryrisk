const visitorStorageKey = 'memoryrisk-analytics-visitor'
const sessionStorageKey = 'memoryrisk-analytics-session'
const queueStorageKey = 'memoryrisk-analytics-queue'
const sessionInactivityMs = 30 * 60 * 1000
const flushDelayMs = 1400
const maxQueueLength = 140
...
function loadQueue() {
  try {
    ...
    if (Array.isArray(parsed)) pendingEvents = parsed.slice(-maxQueueLength)
  } catch {}
}
